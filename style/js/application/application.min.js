$(document).ready(function(){$(window).height();var b=$(window).width(),a=$("#navigation").outerHeight();$(window).resize(function(){b=$(window).width();$(window).height()});$(window).trigger("scroll");$(".centralized").centralized({delay:0,fadeSpeed:0});$.fn.responsivevideos();$("#quote-slider").each(function(){$(".item",this).length&&$(this).carousel({interval:2E4})});$("#main-menu").onePageNav({currentClass:"active",changeHash:!1,
...
username:"TheGridelicious",count:3});$("#twitterfeed-slider").tweetCarousel({interval:7E3,pause:"hover"})});$(document).ajaxSend(function(){0==$(".loading").length&&($("body").append('<div class="loading"><div class="progress progress-striped active"><div class="bar"></div></div></div>'),$(".loading").slideDown())});
